...
public:
	...
	{/*
		CString pBUFFER;
		JinAndWeiAndHeading.Format("WeiDu=%f,JingDu=%f,Heading=%f\n",WeiDu,JingDu,PRHGET.Headingl);*/
		//fwrite(pBuffer,1,/*strlen(pBuffer)*/dwLength,pFileWritePort);
		if(!CN_ASSERT(IsOpen()) || !dwLength)
			return 0;
...
protected:
	...
	virtual void Init() 
	{
		...
		//pFileWritePort=fopen("D:\\WritePort.txt","w");
